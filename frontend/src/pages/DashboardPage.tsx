...
const DashboardPage: React.FC<DashboardPageProps> = ({ data, isLoading = false, error = null, onRefresh }) => {
  ...
  // Use React Query for data fetching if no props provided
  const {
    data: queryData,
    ...
    enabled: !data // Only fetch if no data provided via props
  })

  // Use props data if available, otherwise use query data
  const actualData = data || queryData
  const actualLoading = isLoading || queryLoading
  const actualError = error || queryError
  const actualRefresh = onRefresh || (() => refetch())
  ...
  const stats = actualData?.stats || mockStats
          ...
          <Card className="max-w-2xl mx-auto shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-slate-600 mb-6">
                {actualError instanceof Error ? actualError.message : "We're having trouble loading your dashboard data."}
              </p>
              <div className="flex gap-3 justify-center">
                <Button onClick={actualRefresh} className="bg-blue-600 hover:bg-blue-700">
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">{actualData?.message || "Welcome to your agile workspace"}</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={actualRefresh}>
                      <RefreshCw size={16} className="mr-2" />
                      Refresh Data
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-2xl font-bold text-slate-900">{totalItems as number}</p>
                    ...
                    >
                      <Card className="group hover:shadow-lg transition-all duration-200 cursor-pointer border-slate-200/60">
                        <CardContent className="p-4 text-center">
                          ...
                          <div className="text-2xl font-bold text-slate-900 mb-1">{value as number}</div>
